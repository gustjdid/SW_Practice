...
class CalculatorTest {
	...
	void testAdd() {
		...
		assertEquals(5, calculator.add(2, 3),"2 + 3 should be eqaul 5");
	...
	void testSubtract() {
		...
		assertEquals(1, calculator.subtract(4, 3), "4 - 3 should be eqaul 1");
	...
	void testMultiply() {
		...
		assertEquals(6, calculator.multiply(2, 3), "2 * 3 should be eqaul 6");
	...
	void testDivide() {
		...
		assertEquals(2, calculator.divide(6, 3),"6 / 3 should be equal 2");
	...
	void testDivideByzero() {
		...
		assertThrows(IllegalArgumentException.class,()-> calculator.divide(1, 0),"Divisor cannnot be zero");
